...
export const GET: APIRoute = async (context) => {
  const res = await fetch ("https://app.nocodb.com/api/v2/tables/mj9yvft5vib78kp/records?limit=7&fields=nama,comment,nama_init&sort=-Id&where=(comment_check_auto,eq,true)", {
    method: "GET",
